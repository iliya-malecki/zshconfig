# Generated by Powerlevel10k configuration wizard on 2023-06-01 at 17:02 CEST.
...
# flat tails, 2 lines, solid, left frame, darkest-ornaments, sparse, fluent,
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=251
  ...
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=229
  ...
  function my_git_formatter() {
    ...
    # *42 if have stashes.
    (( VCS_STATUS_STASHES        )) && res+=" ${clean}stash:${VCS_STATUS_STASHES}"
